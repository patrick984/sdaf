...
typedef enum sdaf_compression {
    ...
    SDAF_COMPRESSION_INTEGER = 2,
    SDAF_COMPRESSION_NUMERIC = SDAF_COMPRESSION_INTEGER,
    SDAF_COMPRESSION_BITWISE = 3,
    SDAF_COMPRESSION_BITWISE_NUMERIC = SDAF_COMPRESSION_BITWISE
} sdaf_compression;
